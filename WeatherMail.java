...
public class WeatherMail {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//a[@href='/prognoz/kirov/']]")).click();
        //программа падает на этапе ввода логина, ввиду этого тест с поиском прогноза погоды сделала в отдельный класс Test
